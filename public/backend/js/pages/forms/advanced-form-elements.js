$(function () {
   ...
   // var $demoMaskedInput = $('.demo-masked-input');
    ...
    $('#optgroup').multiSelect({
        selectableHeader: "<div>Tous les videos</div>",
        selectionHeader: "<div class=''>Les videos du playlist</div>",
        selectableFooter: "<div class=''>Tous les videos</div>",
        selectionFooter: "<div class=''>Les videos du playlist</div>" });
    //
    // //noUISlider
