            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Categories<span class="badge bg-blue">{{$category->count()}}</span>
                            </h2>
                                    ...
                                    @foreach($category as $k => $v)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-primary" href="{{route('admin.category.edit',$v)}}">
                                                ...
                                                <form action="{{route('admin.category.destroy',$v)}}" id="form-data-{{$v->id}}" method="post">
                                                    {{csrf_field()}}
