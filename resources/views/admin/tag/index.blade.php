            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Tags<span class="badge bg-blue">{{$tag->count()}}</span>
                            </h2>
                                    ...
                                    @foreach($tag as $k => $v)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-primary" href="{{route('admin.tag.edit',$v)}}">
                                                ...
                                                <form action="{{route('admin.tag.destroy',$v)}}" id="form-data-{{$v->id}}" method="post">
                                                    {{csrf_field()}}
