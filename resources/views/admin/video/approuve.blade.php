                                    ...
                                    @foreach($video as $k => $v)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-success"  onclick="aprouvePost({{$v->id}})">
                                                ...
                                                <form action="{{route('admin.approuve',$v)}}" id="form-aprouve-{{$v->id}}" method="post">
                                                    {{csrf_field()}}
...
<script>
    ...
    function aprouvePost(id) {
        ...
        swalWithBootstrapButtons({
            ...
            type: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Oui, Approuver le!',
            cancelButtonText: 'Non, Annuler!',
            reverseButtons: true
        }).then((result) => {
            if (result.value) {
            document.getElementById('form-aprouve-'+id).submit();
