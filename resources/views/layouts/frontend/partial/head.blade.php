<head>
    <title>{{ config('app.name', 'Site local de visionnage de nouveaute') }}  @yield('title')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Video, video, musique, series, dessin anime, rap, hip hop, song, cartoon" />
    <!-- CSRF Token -->
