    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                ...
                <a class="btn btn-primary waves-effect" href="{{route('user.playlist.create')}}">
                                    ...
                                    @foreach($playlist as $k => $v)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-primary" href="{{route('user.playlist.show',$v)}}">
                                                    <i class="material-icons">menu</i>
                                                </a>
                                                <a class="btn btn-primary" href="{{route('user.playlist.edit',$v)}}">
                                                ...
                                                <form action="{{route('user.playlist.destroy',$v)}}" id="form-data-{{$v->id}}" method="post">
                                                    {{csrf_field()}}
