    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                ...
                <a class="btn btn-primary waves-effect" href="{{route('user.video.create')}}">
                                    ...
                                    @foreach($video as $k => $v)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-primary" href="{{route('user.video.edit',$v)}}">
                                                ...
                                                <form action="{{route('user.video.destroy',$v)}}" id="form-data-{{$v->id}}" method="post">
                                                    {{csrf_field()}}
